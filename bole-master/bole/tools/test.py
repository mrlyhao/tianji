...
def tianyancha(ip,url1):
    ...
    # url1='http://www.qichacha.com/firm_20708af4c7e049a334b4a9fb12b3edd3.html'
    proxies = {"http": ip,}
    print(proxies)
    ...
    a= requests.get(url,headers=headers,proxies=proxies,timeout=1).text
    b= requests.get(url1,headers=headers1,proxies=proxies,timeout=1).text
    # print(url,a)
    print(url1,b)
# print(ip)
# tianyancha(ip)
