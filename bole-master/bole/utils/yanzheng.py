...
def get_ip():
    try:
        url='http://http-api.taiyangruanjian.com/getip?num=5&type=2&pro=&city=0&yys=0&port=1&pack=14625&ts=0&ys=0&cs=0&lb=1&sb=0&pb=4&mr=0&regions='
...
class YanzhengIP(object):
    ...
    def judge_ip(self, ip):
        ...
        try:
            ...
            response = requests.get(http_url, proxies=proxy_dict,headers=headers,timeout=3)
